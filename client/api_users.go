 ...
 * @param "User" (optional.Interface of User) -  User to create
@return User
*/
func (a *UsersApiService) CreateUser(ctx _context.Context, localVarOptionals *CreateUserOpts) (User, *_nethttp.Response, error) {
	var (
...
// IssueTokenOpts Optional parameters for the method 'IssueToken'
type IssueTokenOpts struct {
    IssueTokenRequest optional.Interface
}
 ...
 * @param optional nil or *IssueTokenOpts - Optional Parameters:
 * @param "IssueTokenRequest" (optional.Interface of IssueTokenRequest) - 
@return TokenResponse
*/
func (a *UsersApiService) IssueToken(ctx _context.Context, username string, localVarOptionals *IssueTokenOpts) (TokenResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.IssueTokenRequest.IsSet() {
		localVarOptionalIssueTokenRequest, localVarOptionalIssueTokenRequestok := localVarOptionals.IssueTokenRequest.Value().(IssueTokenRequest)
		if !localVarOptionalIssueTokenRequestok {
			return localVarReturnValue, nil, reportError("issueTokenRequest should be IssueTokenRequest")
		}
		localVarPostBody = &localVarOptionalIssueTokenRequest
	}
 ...
 * @param "LoginRequest" (optional.Interface of LoginRequest) - 
@return TokenResponse
*/
func (a *UsersApiService) Login(ctx _context.Context, username string, localVarOptionals *LoginOpts) (TokenResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if localVarOptionals != nil && localVarOptionals.LoginRequest.IsSet() {
		localVarOptionalLoginRequest, localVarOptionalLoginRequestok := localVarOptionals.LoginRequest.Value().(LoginRequest)
		if !localVarOptionalLoginRequestok {
			return localVarReturnValue, nil, reportError("loginRequest should be LoginRequest")
		}
 ...
 * @param "User" (optional.Interface of User) -  Partial user containing fields to update
@return User
*/
func (a *UsersApiService) UpdateUser(ctx _context.Context, username string, localVarOptionals *UpdateUserOpts) (User, *_nethttp.Response, error) {
	var (
